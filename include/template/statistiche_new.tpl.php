                                                    ...
                                                    <div class="col-xs-12 col-md-12 col-lg-12">
                                                        <div class="box box-default">
                                                            <div class="box-header with-border pointer-hover" data-toggle="collapse" data-target="#wrap_table_stats_other">
                                                                <h5>Annullate dall'operatore</h5>
                                                                <div class="box-tools pull-right">
                                                                    <a  data-toggle="collapse" data-target="#wrap_table_stats_other"><i class="fa fa-plus"></i></a>
                                                                </div>
                                                            </div>
...
<script>
    j(function () {
        ...
        function updateTable(isCompare, start, end) {
            ...
            j("#tab-loading").fadeIn();
            j.post({
                url: '<?php echo BASE_URL_SITO ?>ajax/statistiche/statistiche_new_table.php',
                data: {
                    'id_sito': <?php echo IDSITO ?>,
                    'start': startDate,
                    'end': endDate,
        ...
        j('body').on('click', '.show-detail', function () {
            ...
            j('#modal-details-table').DataTable({
                ajax: '<?php echo BASE_URL_SITO ?>ajax/statistiche/statistiche_new_details.php/?' + encodeQueryData(params),
                destroy: true,
                columns: [
                    {title: "Id"},
