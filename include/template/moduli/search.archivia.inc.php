 <?php
    ...
    $form_ricerca .= '
                                    <div class="modal fade" id="myModalASearchArchivio" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                            ...
                                                            <div class="row">
                                                              <div class="col-md-12 text-center">
                                                                  <div class="alert alert-info text-black text-center f-11">
                                                                    <b>Suggerimenti e trucchi:</b><div class="clearfix p-b-10"></div> 
                                                                    Impostando le <b>date richiesta</b>; il filtro per <b>anno</b> ('.$_REQUEST['azione'].') viene <b>annullato</b>, quindi siete liberi di andare '.($_REQUEST['azione']==date('Y')?'':'avanti e/o').' indietro nel tempo!
                                                                    <br><br>
                                                                    <em>Esempio: Dal 01/01/2020 ad oggi '.date('d/m/Y').',  ed effettuate una ricerca per Nome, Cognome e/o Numero prenotazione, ecc., il filtro viene applicato su tutto il DB dal 2020 al '.date('Y').', e non solo nell\'anno dell\'archivio scelto!</em>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                          ').'                                                 
