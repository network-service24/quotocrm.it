                            ...
                            <div class="main-body">
                                ...
                                <div id="fatturatoN" class="card">
                                    ...
                                    <div class="text-center" style="width:100%!important"><b>Metodo raccolta dati tramite Tracking Ads</b></div>
                                        <h5 class="box-title" style="width:100%!important">Totale <b>Fatturato Newsletter Ads</b> <?=($totalePPCn>0?' <span>&#10230;</span> <span class="text-success" style="font-size: 30px;"><i class="fa fa-euro"></i> '.number_format($totalePPCn,2,',','.').'</span>':'')?></h5>  
                                              <div class="box-body">
