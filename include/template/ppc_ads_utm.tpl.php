                                    ...
                                    <div class="card-block">
                                            <div class="row">
                                                ...
                                                <div class="col-md-10 col-sm-10 col-xs-10">
                                                    ...
                                                    <?= $js_load ?>
                                                    <h5><img src="<?= BASE_URL_SITO ?>img/gads.png" style="width:32px;height:32px"/>  Fonte di prenotazione <b>Google Ads</b>: per campagne social. <span class="f-11">(tracciabilità ottenuta da UTM QUOTO)</span></h5>
