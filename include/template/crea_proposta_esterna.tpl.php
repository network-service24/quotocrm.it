                        ...
                        <div class="card bg_proposta_yellow" id="fixed_menu_proposte">
                            <div class="card-block">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <h2 class="text-primary">Crea Prenotazione Esterna per Check-in OnLine</h2> 
                                        ...
                                        <ul id="menu_proposta">
                                            ...
                                            <li class="p-0"><button type="submit" id="bottone_salva" onclick="check_prezzo()" class="btn btn-success">Inserisci Prenotazione</button></li>
                                        </ul> 
                                                                ...
                                                                <div class="row m-t-10">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="Cognome" id="Cognome" class="form-control" value="" required>
                                                                        </div>                                                        
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label  class="control-label"><b>Email</b></label>
                                                                            <input type="email" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,}" required name="Email" id="Email" class="form-control" value="">
                                                                ...
                                                                <div class="row m-t-10">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="Cellulare" id="Cellulare" class="form-control" value="">
