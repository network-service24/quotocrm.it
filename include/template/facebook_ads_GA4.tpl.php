                ...
                <div class="page-body">
                                <div class="alert alert-default text-center text-black">
                                    <ul>
                                        ...
                                        <li>La <b>sincronizzazione</b> dei dati con <b>Analytics GA4</b> ha <b>48 ore di scarto</b>, per esempio: se un preventivo e/o una prenotazione proveniente da "Sito Web -> campagna facebook" entrata il 01-00-0000 sarà visibile nel modulo statistico di GA4 il 03-00-0000</li>                                                                                                                               
                                    </ul>
                                </div>
                                <div class="card">
                                    <div class="card-block">
                                            <div class="row">
                                                ...
                                                <div class="col-md-10 col-sm-10 col-xs-10">
                                                    ...
                                                    <?= $js_load ?>
                                                    <h5><i class="fa fa-facebook-square fa-2x" style="color:#3B5897"></i>  Fonte di prenotazione <b>Facebook Ads</b>: per campagne social. <span class="f-11">(tracciabilità ottenuta da Analytics GA4)</span></h5>
