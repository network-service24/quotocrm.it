                            ...
                            <div class="main-body">
                                ...
                                <? include_module('breadcrumb.inc.php'); ?>
                                    <div class="page-body">
                                            ...
                                            <h5>Statistiche di dettaglio metodo <strong><?php echo $method ?></strong></h5>
...
<script>
    j(function () {
        ...
        function updateChart(isCompare, start, end) {
            ...
            j.post({
                url: '<?php echo BASE_URL_SITO ?>ajax/statistiche/statistiche_new_graph.php',
                data: {
        ...
        function updateTable(isCompare, start, end) {
            ...
            j("#tab-loading").fadeIn();
            j.post({
                url: '<?php echo BASE_URL_SITO ?>ajax/statistiche/statistiche_new_table_detail.php',
                data: {
                    'id_sito': <?php echo IDSITO ?>,
...
/*          function updateTableAnnulled(isCompare, start, end) {
        ...
        j('body').on('click', '.show-detail', function () {
            ...
            j('#modal-details-table').DataTable({
                ajax: '<?php echo BASE_URL_SITO ?>ajax/statistiche/statistiche_new_details_website.php/?' + encodeQueryData(params),
                destroy: true,
                columns: [
                    {title: "Id"},
