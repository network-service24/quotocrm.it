                                            ...
                                            <div class="card-block">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2 text-center">
                                                        <small>
                                                            <form method="post" name="filter_year" id="filter_year" action="<?=$_SERVER['REQUEST_URI']?>">
                                          ...
                                          <div id="fatturatoN" class="card">
                                            <div class="card-block">
                                                <div class="text-center" style="width:100%!important"><b>Metodo raccolta dati tramite Tracking Ads</b></div>
                                                  <h5 class="box-title" style="width:100%!important">Totale <b>Fatturato Facebook Ads</b> <i class="fa fa-facebook-square fa-2x" style="color:#3B5897"></i> <?=($totaleFBn>0?' <span>&#10230;</span> <span class="text-success" style="font-size: 30px;"><i class="fa fa-euro"></i> '.number_format($totaleFBn,2,',','.').'</span>':'')?></h5>
                                                <div class="box-body">
                                                    ...
                                                    <div class="row m-t-10">
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                          <h5 class="box-title">Fonte di prenotazione <b>Facebook Ads</b></h5>                                                               
                                                          <div class="box-body">                                                                  
                                                                <div class="row m-t-10">
