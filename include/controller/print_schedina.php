<?php
        ...
        $select2 = $dbMysqli->query('SELECT siti.*,
...
$pulsante_indietro ='<a class="btn btn-warning " href="'.BASE_URL_SITO.'checkinonline-schedine_alloggiati/"><i class="fa fa-arrow-left"></i> torna indietro</a><div class="clearfix p-b-20"></div>';
?>