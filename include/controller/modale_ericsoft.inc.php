<?php
    ...
    $array_person = $fun->get_pms_person(IDSITO,'E');
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="myModalLabel">Inserisci i dati utili per il Booking Ericsoft</h5>
             ...
             <div class="row">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-group">
                                    <input id="DataArrivoE<?=$numE?>" name="DataArrivoE<?=$numE?>" min="<?=$DataDiOggi?>" type="date" class="form-control" autocomplete="off" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-group">
                                    <input id="DataPartenzaE<?=$numE?>" name="DataPartenzaE<?=$numE?>" min="<?=$DataDiDomani?>" type="date" class="form-control"  autocomplete="off" />
                                </div>
                            </div>
                        </div>  
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <button type="button" class="btn btn-primary" id="SB_booking<?=$numE?>E"  data-dismiss="modal" aria-label="Close">Controlla disponibilità </button>
                    </div>
                </div> 
                <script>
                    $(document).ready(function(){
                        $("#DataArrivoE<?=$numE?>").change(function () {
                            var dateAE = new Date($("#DataArrivoE<?=$numE?>")[0].valueAsDate);
                            dateAE.setDate(dateAE.getDate() + 1);
                            $('#DataPartenzaE<?=$numE?>')[0].valueAsDate = dateAE;
                        })
                    })
                </script>
            </div>
