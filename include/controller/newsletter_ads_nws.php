...
$anniprima = (date('Y')-$diff_anni);
 ...
 $sqln = "SELECT hospitality_tracking_ads.NumeroPrenotazione
                ...
                AND hospitality_tracking_ads.Tracking = 'newsletter'
                AND Campagna != ''";
    ...
    if($totCampn>0){
        ...
        foreach($array_campagnen as $k => $vl){
            ...
            $n_landing    = numero_campagne_da_landing_old(IDSITO,'newsletter',$vl,'landing');
            $n_sito       = numero_campagne_da_sito_old(IDSITO,'newsletter',$vl,'sito');
        ...
        foreach ($array_fatturatoSn as $yn => $valn) {
            ...
            if($valn!="" || $valn != 0){
                ...
                $n_landingS    = numero_campagne_da_landing_old(IDSITO,'newsletter',$yn,'landing');
                $n_sitoS       = numero_campagne_da_sito_old(IDSITO,'newsletter',$yn,'sito');
                $numero_chiuse = n_campagne_chiuse(IDSITO,'newsletter',$yn);
