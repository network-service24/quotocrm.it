...
$content .='<script>
            ...
            //EQUALIZZO BOX DETTAGLI
                ...
                var table = $("#profila").DataTable( {
                    ...
                    "ajax": "'.BASE_URL_SITO.'crud/proposte/profila.crud.php?idsito='.IDSITO.''.$variabili.'",
                    "deferRender": true,
                    "columns": ['."\r\n";
        ...
        $content .='    "columnDefs": [
                    ...
                    $(".buttonExport").after("<button class=\"dt-button buttons-collection buttonExportFull\" onclick=\"document.getElementById(\'form_export\').submit();\" id=\"pulsante_esporta\" data-toggle=\"tooltip\" title=\"Questo Export scarica il contenuto del Profila in CSV!\"><i class=\"fa fa-file-archive-o fa-2x fa-fw\"></i> Esporta CSV</button>");
...
$content .='<form style="padding: 3px 20px !important;" id="form_export" name="form_export" action="'.BASE_URL_SITO.'include/controller/export_clienti_quoto.php">
