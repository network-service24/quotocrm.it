      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="myModalLabel">Inserisci i dati utili per il Booking Bedzzle</h5>
             ...
             <div class="row">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-group">
                                    <input id="DataArrivoBedzzle<?=$numBedzzle?>" name="DataArrivoBedzzle<?=$numBedzzle?>" min="<?=$DataDiOggi?>" type="date" class="form-control" autocomplete="off" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-group">
                                    <input id="DataPartenzaBedzzle<?=$numBedzzle?>" name="DataPartenzaBedzzle<?=$numBedzzle?>" min="<?=$DataDiDomani?>" type="date" class="form-control"  autocomplete="off" />
                                </div>
                            </div>
                        </div>  
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <button type="button" class="btn btn-primary" id="SB_booking<?=$numBedzzle?>Bedzzle"  data-dismiss="modal" aria-label="Close">Controlla disponibilità</button>
                    </div>
                </div> 
                <script>
                    $(document).ready(function(){
                        $("#DataArrivoBedzzle<?=$numBedzzle?>").change(function () {
                            var dateAB = new Date($("#DataArrivoBedzzle<?=$numBedzzle?>")[0].valueAsDate);
                            dateAB.setDate(dateAB.getDate() + 1);
                            $('#DataPartenzaBedzzle<?=$numBedzzle?>')[0].valueAsDate = dateAB;
                        })
                    })
                </script>        
            </div>
