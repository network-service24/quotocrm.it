            ...
            //EQUALIZZO BOX DETTAGLI
                ...
                // CONFIG DATATABLE
                 var table = $("#archivio").DataTable( {
                    ...
                    "ajax": "'.BASE_URL_SITO.'crud/proposte/archivio.crud.php?idsito='.IDSITO.''.$variabili.'",
                    "deferRender": true,
                    "columns": ['."\r\n";
