<?php
    ...
    if($tot == 0){
     ...
     <table id="recall_preventivi" class="display compact dataTable table table-striped table-hover table-bordered table-sm f-13"  style="width:100%">
          <thead>
              <tr>';
...
$content .='<style>
      ...
      #recall_preventivi_filter{
          display: none !important;
      }
      .dt-buttons{
          display: none !important;
      }
      #recall_preventivi_info{
          display: none !important;
      }
  </style>'."\r\n";
...
$content .='                                                                     
      ...
      // CONFIG DATATABLE
      var table = $("#recall_preventivi").DataTable( {
          ...
          "ajax": "'.BASE_URL_SITO.'crud/autoresponder/configura_recall.crud.php?idsito='.IDSITO.'",
          "deferRender": true,
          "columns": ['."\r\n";
...
$content .='    "columnDefs": [
          ...
          $("#recall_preventivi_processing").removeClass("card");'."\r\n";
