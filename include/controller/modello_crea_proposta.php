        ...
        <tr>
            ...
            <td class="td10 no-border-top">
                <div class="form-group">
                    ...
                    <select required name="NumAdulti1[]" id="NumeroAdulti_1_1" class="form-control" '.(($fun->check_simplebooking(IDSITO)==0 && $fun->check_ericsoftbooking(IDSITO)==0 && $fun->check_bedzzlebooking(IDSITO)==0)?($fun->check_listini(IDSITO)==1?'onChange="get_listino(1,1);"':''):'').'>
                        '.$NumeroAdulti.'
                    </select>
                </div>
            </td>
...
<div class="table-responsive">
        ...
        <tr>
            ...
            <td class="td10 no-border-top">
                <div class="form-group">
                    <label class="control-label"><b>Adulti</b></label>
                    <select name="NumAdulti2[]" id="NumeroAdulti_2_1" class="form-control" '.(($fun->check_simplebooking(IDSITO)==0 && $fun->check_ericsoftbooking(IDSITO)==0 && $fun->check_bedzzlebooking(IDSITO)==0)?($fun->check_listini(IDSITO)==1?'onChange="get_listino(2,1);"':''):'').'>
                        '.$NumeroAdulti.'
                    </select>
                </div>
            </td>
...
<div class="table-responsive">
        ...
        <tr>
            ...
            <td class="td10 no-border-top">
                <div class="form-group">
                    <label class="control-label"><b>Adulti</b></label>
                    <select name="NumAdulti3[]" id="NumeroAdulti_3_1" class="form-control"  '.(($fun->check_simplebooking(IDSITO)==0 && $fun->check_ericsoftbooking(IDSITO)==0 && $fun->check_bedzzlebooking(IDSITO)==0)?($fun->check_listini(IDSITO)==1?'onChange="get_listino(3,1);"':''):'').'>
                        '.$NumeroAdulti.'
                    </select>
                </div>
            </td>
...
<div class="table-responsive">
        ...
        <tr>
            ...
            <td class="td10 no-border-top">
                <div class="form-group">
                 <label class="control-label"><b>Adulti</b></label>
                    <select name="NumAdulti4[]" id="NumeroAdulti_4_1" class="form-control" '.(($fun->check_simplebooking(IDSITO)==0 && $fun->check_ericsoftbooking(IDSITO)==0 && $fun->check_bedzzlebooking(IDSITO)==0)?($fun->check_listini(IDSITO)==1?'onChange="get_listino(4,1);"':''):'').' >
                        '.$NumeroAdulti.'
                    </select>
                </div>
            </td>
...
<div class="table-responsive">
        ...
        <tr>
            ...
            <td class="td10 no-border-top">
                <div class="form-group">
                 <label class="control-label"><b>Adulti</b></label>
                    <select name="NumAdulti5[]" id="NumeroAdulti_5_1" class="form-control"  '.(($fun->check_simplebooking(IDSITO)==0 && $fun->check_ericsoftbooking(IDSITO)==0 && $fun->check_bedzzlebooking(IDSITO)==0)?($fun->check_listini(IDSITO)==1?'onChange="get_listino(5,1);"':''):'').'>
                        '.$NumeroAdulti.'
                    </select>
                </div>
            </td>
