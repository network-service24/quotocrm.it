<?php
            ...
            $content = '<!--  custom.functions .js -->
                        ...
                        <div id="result_no_disp'.$_REQUEST['azione'].'" class="alert alert-success text-center" style="display:none">
                                            ...
                                            <script>
                                                $(document).ready(function() {
                                                    ...
                                                    $("#invio_email_no_dispo'.$_REQUEST['azione'].'").on("submit",function(){
                                                        ...
                                                        $.ajax({
                                                            type: "POST",
                                                            url: "'.BASE_URL_SITO.'ajax/preventivi/send_no_dispo_preventivi.php",
                                                            data: dati,
