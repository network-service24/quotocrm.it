<?php
    ...
    if($tot == 0){
     ...
     <table id="recensioni" class="display compact dataTable table table-striped table-hover table-bordered table-sm f-13"  style="width:100%">
          <thead>
              <tr>';
...
$content .='                                                                     
      ...
      // CONFIG DATATABLE
      var table = $("#recensioni").DataTable( {
          ...
          "ajax": "'.BASE_URL_SITO.'crud/autoresponder/configura_recensioni.crud.php?idsito='.IDSITO.'",
          "deferRender": true,
          "columns": ['."\r\n";
...
$content .='    "columnDefs": [
          ...
          $("#recensioni_processing").removeClass("card");'."\r\n";
