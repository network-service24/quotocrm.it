...
$select2 .= " AND Brand = 'YES' ";
$select2 .= " AND Affiliation IS NULL ";
$select2 .= " AND Transactions IS NULL ";
$select2 .= " AND Transaction_revenue IS NULL ";
...
echo '<script type="text/javascript">
		$(document).ready(function() {
					$("#valore_RMKT_' . $num_id . '").val(\'' . $valore2 . '\');
					$("#icona_RMKT_' . $num_id . '").html(\'' . $icona . '\');
