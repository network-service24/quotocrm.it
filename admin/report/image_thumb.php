...
$thumb=new thumbnail($_REQUEST['img']); // prepare to generate "shiegege.jpg" in directory "/www"
//$thumb->size_width($_REQUEST['w']);
//$thumb->size_height($_REQUEST['h']);
$thumb->size_auto($_REQUEST['h']);	
$thumb->jpeg_quality(95);		   // set width for thumbnail with 100 pixels
