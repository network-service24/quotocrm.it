    ...
    $.fn.extend({
        passwordRequirements: function(options) {
            ...
            return this.each(function() {
                ...
                o.infoMessage = 'La lunghezza minima della password è di ' + o.numCharacters + ' caratteri e deve contenere almeno 1 lettera minuscola, 1 lettera maiuscola, 1 numero. ';
				// Add Variables for the li elements
				var numCharactersUI = '<li class="pr-numCharacters"><span></span>Caratteri 8</li>',
					useLowercaseUI = '',
					useUppercaseUI = '',
					useNumbersUI   = '',
					useSpecialUI   = '';
				...
				if (o.useLowercase === true) {
					useLowercaseUI = '<li class="pr-useLowercase"><span></span>Lettera miniuscola</li>';
				}
