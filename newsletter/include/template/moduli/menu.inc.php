<div class="col-md-2">
<a href="<?=BASE_URL_SITO?>newsletter/<?=URL_CLIENT_EMAIL?>-crea/" class="btn btn-warning m-b-20 p-10 btn-block waves-effect waves-light"><i class="fa fa-send"></i> &nbsp;&nbsp;Componi e-mail</a><br>
    ...
    <h3 class="card-title m-t-40">Liste <span class="claerfix f-11">(clicca sul nome per modifcare)</span></h3>
    <div class="list-group b-0 mail-list"> 
        <ul class="list-group list-group-full">
        <?
                $query_generale  = "SELECT * FROM mailing_newsletter_nome_liste	WHERE idsito = ".IDSITO." ORDER BY nome_lista DESC";  
                $arr_rec        = $dbMysqli->query($query_generale);
        ...
        <div class="alert alert-default text-black">
                <span class="f-11">  
                  <b>ATTENZIONE:</b><br>
                    ...
                    <i class="fa fa-check-square-o text-black" aria-hidden="true"></i> / <i class="fa fa-square-o text-black" aria-hidden="true"></i> caricandovi però di ogni responsabilità ad essa collegata, liberando così Network Service s.r.l. da ogni onere ed obbligo!<br>                           
                    <br>
                    L'invio dell'email in <?=NOME_CLIENT_EMAIL?>, avverrà solo per l'utente che avrà accettato il <b>"Consenso .... marketing"</b>  <i class="fa fa-check-square-o text-black" aria-hidden="true"></i> !!
                </span>
        </div>
    </div>
</div>