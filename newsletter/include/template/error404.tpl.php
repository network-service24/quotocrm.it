...
<body class="bubble">
    ...
    <a href="<?=BASE_URL_SITO?>dashboard-index/" class="logo-link" title="back home">
    ...
    <div class="content">
        <div class="content-box">
            ...
            <p>La pagina che stavi cercando non esiste.<br>Pensiamo che la pagina potrebbe essere stata spostata o rimossa.</p>
                <br><br>
