                                        ...
                                        <div id="content_login">
                                            ...
                                            <div class="form-group">
                                                <div class="d-flex no-block align-items-center">
                                                    ...
                                                    <div class="ml-auto">
                                                        <i class="fa fa-lock m-r-5 text-muted"></i> <a href="lost_password.php" id="to-recover" class="text-muted" data-toggle="tooltip" data-html="true"  title="Per il recupero dei dati d'accesso, ti verrà richiesto l'inserimento del dominio del sito e dell'email associati a QUOTO!">Smarrito gli accessi?</a><i class="fa fa-info-circle text-info cursore m-l-5" data-toggle="tooltip" data-html="true"  title="<div class=text-center p-5>ATTENZIONE!<br> Il recupero dei dati di accesso è riferito solo all'utente <b>SuperUser</b>, <em>ossia quello creato dall'operatore Network Service in fase di setup del software</em>.<br>Tramite questo utente potete entrare nel CRM e dalla voce di configurazione <b>Accessi -> Gestione Permessi</b>, potete visualizzare i dati di ogni operatore che avete abilitato all'uso del software!</div>"></i>
                                                    </div>
                                                </div>
                                            </div>
