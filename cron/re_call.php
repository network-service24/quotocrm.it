...
require $_SERVER['DOCUMENT_ROOT'].'/class/PHPMailer/PHPMailerAutoload.php';
    ...
    function check_landing_type_template($idsito, $idrichiesta){
        ...
        $sel = "SELECT hospitality_guest.*, hospitality_giorni_recall_preventivi.numero_giorni 
                ...
                INNER JOIN hospitality_giorni_recall_preventivi ON hospitality_giorni_recall_preventivi.idsito = hospitality_guest.idsito
                WHERE 1 = 1
                ...
                AND hospitality_giorni_recall_preventivi.abilita = 1
                AND hospitality_guest.DataScadenza =  (CURRENT_DATE + INTERVAL hospitality_giorni_recall_preventivi.numero_giorni  DAY)";
        $qy  = $dbMysqli->query($sel);
        $tot = sizeof($qy);
        if($tot > 0){

            $myfile = fopen($path_cron.'log/log_recall.txt', 'w'); 
                       ...
                       // giro le date in formato IT
                        ...
                        $NumeroPrenotazione = $dati['NumeroPrenotazione'];
                            ...
                            $res = $dbMysqli->query($select);
                                ...
                                $_oggetto           =     $etichetta['OGGETTO_RECALL_PREVENTIVI'];
                                $_testo             =     $etichetta['TESTOMAIL_RECALL_PREVENTIVI']; 
                        ...
                        include $path_cron.'email_template/recall_preventivo_mail.php';
                        ...
                        $dbMysqli->query("INSERT  INTO hospitality_traccia_email_cron (IdRichiesta,Idsito,DataAzione,TipoReInvio) VALUES ('".$IdRichiesta."','".$IdSito."','".date('Y-m-d H:i:s')."','ReCall')");
