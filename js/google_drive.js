    ...
    function SetPicker() {
        var picker = new FilePicker(
            {
                apiKey: 'AIzaSyAXIgZleYRDFPhH26qsJ9ug1Et18B7eAlI',
                clientId: '909015881130-pkpcgpmuoibckkl0ole58l48esg3ql1i.apps.googleusercontent.com',
                buttonEl: document.getElementById("AllFilePick"),
                onClick: function (file) {

                    PopupCenter('https://drive.google.com/file/d/' + file.id + '/view', "", 1440, 900);
                }
            });
    }
    ...
    FilePicker.prototype = {
        ...
        ShowPicker: function () {
            ...
            this.picker = new google.picker.PickerBuilder().
                ...
                setTitle('Google Drive: lista dei file').
                build().
                setVisible(true);
        },
