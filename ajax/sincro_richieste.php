...
$db_suiteweb = new MysqliDb($h, $user, $pass, $db_n);
...
function from_id_to_cod($value)
{
    ...
    function syncro_form_sito($idsito,$data_attivazione){
            ...
            if($tot > 0){
                ...
                $output = 'Sincronia con richieste informazioni per  '.SITOWEB.' avvenuta con successo'."\r\n"; 
            }else{
                $output = 'Nessuna sincronizzazione'."\r\n"; 
            }
  ...
  $data_attivazione = $_REQUEST['data_attivazione'];
  syncro_form_sito($idsito,$data_attivazione) 
  ?>