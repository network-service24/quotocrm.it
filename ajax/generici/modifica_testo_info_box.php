...
include($_SERVER['DOCUMENT_ROOT']."/include/declaration.inc.php");
 	...
 	if($_REQUEST['action']=='mod_info_box'){
            ...
            $update ="  UPDATE hospitality_info_box_lang  SET Lingua = '".$lingua."', Titolo = '".$titolo."', Descrizione = '".$descrizione."' WHERE Id = ".$id." AND idsito =  ".$idsito;
