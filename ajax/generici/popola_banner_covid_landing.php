...
include($_SERVER['DOCUMENT_ROOT']."/include/declaration.inc.php");
      ...
      if($_REQUEST['idsito']){
        ...
        $TestoDEU       = 'Hier ist die Antwort für '.$v['nome'].' um noch sicherere und friedlichere Aufenthalte zu gewährleisten!
                ...
                $select = "SELECT Id FROM hospitality_banner_info WHERE idsito = ".$_REQUEST['idsito']." ORDER BY Id DESC";
                $r      = $dbMysqli->query($select);  
                $rec    = $r[0];
                $IdBannerInfo = $rec['Id'];
                ...
                foreach($lingue as $key => $value) {
                        ...
                        $ins = "INSERT INTO hospitality_banner_info_lang(
                                            idsito,
                                            IdBannerInfo,
                                            Lingua,
                                            Titolo,      
