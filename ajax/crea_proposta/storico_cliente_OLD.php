...
include($_SERVER['DOCUMENT_ROOT']."/include/function.inc.php");
		...
		if($tot > 0){
				...
				if($value['TipoRichiesta'] == 'Preventivo'){
					...
					$output .= '<div class="card">
                                    <div class="card-block">
                                        <div id="view'.$IdProposta.'" class="cursore f-14"><i class="fa fa-angle-double-right m-r-10"></i>Preventivo Nr. '.$NumeroPrenotazione.' del '.$DataRichiesta.'</div>
			...
			echo '<div class="card bg_blocchi_proposta">
                    <div class="card-block">
                        <span class="f-16 f-w-600">Storico del cliente già stato nostro ospite:</span>
                            <br><br>
                        <div class="f-13">
                            '.$output.'
                            <script>
