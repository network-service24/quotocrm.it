...
include($_SERVER['DOCUMENT_ROOT']."/include/declaration.inc.php");
    ...
    if($notti!='' && $notti !='undefined'){
        ...
        if($ret['CalcoloPrezzo']=='Al giorno'){
            ...
            $testo = '<div><button class="btn btn-primary btn-mini"  type="button" data-toggle="modal" data-servizio="'.$TipoServizio.'" data-prezzo="'.$PrezzoServizio.'" data-notti="'.$notti.'" data-id_servizio="'.$id_servizio.'"  data-target="#modify_modal_persone_'.$n_proposta.'_'.$id_servizio.'">Calcola</button></div>';
