...
include($_SERVER['DOCUMENT_ROOT']."/include/declaration.inc.php");
    ...
    if($_REQUEST['action'] == 'send_email_no_dispo') {
                ...
                switch($Lingua){
                    case "it":
                        $oggetto   = 'Gentile '.$Nome.' '.$Cognome.' la sua conferma Nr.'.$NumeroPrenotazione.' di proposta soggiorno presso la nostra struttura ricettiva è stata annullata!'; 
                                    ...
                                    <body>
                                        <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                            <tr>
                                                ...
                                                <img src="'.BASE_URL_SITO.'uploads/loghi_siti/'.$logo.'"><br><br>
                                                    '.$contenuto.'
                                                </td>
                                            </tr>
                                            <tr>
