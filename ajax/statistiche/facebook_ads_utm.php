...
if ($totCampn > 0) {
    ...
    foreach ($rws9n as $key9n => $value9n) {
        ...
        $numero_campagne   = $stat->CountRicevuteCampagnaAds($idsito,$value9n['Campagna'],'facebook','social',$filter_query);
        $numero_prev_send  = $stat->CountInviateCampagnaAds($idsito,$value9n['Campagna'],'facebook','social',$filter_query);
