                    ...
                    foreach($emails as $mail) {
                        ...
                        $maildata = $data_anno.'-'.$mesi[$data_mese].'-'.$data_giorno.' '.$ora_mail;
                            ...
                            if($maildata > $last_data_import){ 
                                ...
                                if(strstr($headerInfo->subject,'SPA HOTELS COLLECTION')){ 
                                    ...
                                    $arr_field['H_SP']      = array('Codice' => 'Codice email');                

                                    $array_contenuti_email[$tipo_modulo][] =array('BODY' => $righe); 

                                }// fine provenineza da SPA HOTELS COLLECTION
                    ...
                    if($key != ''){
                     ...
                     foreach($value as $k => $val){
                        ...
                        $Camere             = '';
                                            ...
                                            //
                                            $FontePrenotazione  = 'spahotelscollection.it';
                                            ...
                                            $Note        = ($NumeroBambini > '0'?'Età bambini: '.$EtaBambini."\r\n":'').($TestoNote!=''?'Note: '.$TestoNote:'');
                                            $AbilitaInvio       = '0';


                                        if($Nome != '' && $DataArrivo != '' && $DataPartenza != '' && $Email != ''){
            ...
            for($i=$total-1;$i>=0;$i--) {
                ...
                $maildata = $data_m[2].'-'.$mesi[$data_m[1]].'-'.$data_m[0].' '.$ora_mail;
                    ...
                    if($maildata > $last_data_import){  
                        ...
                        if((strstr($email['header']->subject,'Richiesta')) && (strstr($email['header']->subject,'SPA HOTELS COLLECTION'))){
