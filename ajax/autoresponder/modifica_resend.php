...
include($_SERVER['DOCUMENT_ROOT']."/include/declaration.inc.php");
 	...
 	if($_REQUEST['action']=='mod_resend'){
            ...
            $update ="UPDATE hospitality_giorni_recall_conferme SET numero_giorni   = '".$numero_giorni."', abilita = '".$abilita."' WHERE id =  ".$id." AND idsito = ".$idsito;
