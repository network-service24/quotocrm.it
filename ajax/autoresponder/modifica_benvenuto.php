...
include($_SERVER['DOCUMENT_ROOT']."/include/declaration.inc.php");
 	...
 	if($_REQUEST['action']=='mod_benvenuto'){
            ...
            $update ="UPDATE hospitality_giorni_reselling SET numero_giorni   = '".$numero_giorni."', abilita = '".$abilita."' WHERE id =  ".$id." AND idsito = ".$idsito;
