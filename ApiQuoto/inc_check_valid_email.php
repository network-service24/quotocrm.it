<?php
/*
## File utile per la chiamata in asincorno dai form RenderFomV4 e RenderFormv5
## scrivendo dentro il campo EMAIL, si attiva la chiamata che controlla in tempo reale
## il record MX della casella, se l'email digitata è ESISTENTE (reale) oppure INVALID (inesistente)
...
$Controllo = verifyEmail($EmailCliente,$EmailOperatore);
