                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content" style="width:100%">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Modifica contenuti per l\'oggetto mail del modulo Check-In Online</h4>
                                                                    ...
                                                                    <script>
                                                                        $(document).ready(function() {
                                                                            $("#form_up_oggetto'.$row['id'].'").submit(function () {   
                                                                                ...
                                                                                $.ajax({
                                                                                    url: "'.BASE_URL_SITO.'ajax/autoresponder/modifica_testo_oggetto_checkin.php",
                                                                                    type: "POST",
                                                    ...
                                                    $(document).ready(function(){ 
                                                        $("#delete_testo_oggetto'.$row['id'].'").on("click",function(){
                                                            if (window.confirm("ATTENZIONE: Sicuro di voler eliminare questo Record?")){
                                                                $.ajax({
                                                                    url: "'.BASE_URL_SITO.'ajax/autoresponder/delete_testo_oggetto_checkin.php",
                                                                    type: "POST",
