...
include($_SERVER['DOCUMENT_ROOT']."/include/function.inc.php");
	...
	foreach($rec as $key => $row){
                            ...
                            $modale .= '<div class="modal fade" id="ModaleUpBenvenuto'.$row['id'].'" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form id="form_up_benvenuto_content'.$row['id'].'" name="form_up_benvenuto_content" method="POST" action="'.BASE_URL_SITO.'ajax/autoresponder/modifica_modulo_benvenuto_content.php">'."\r\n";                                          
                                if($row['textarea']==0){                                
                                    ...
                                    $modale .= '                    <div class="form-group">  
                                                                <div class="row">
                                                                    <div class="col-md-12 text-center">
                                                                        ...
                                                                        <input type="hidden" name="action"  value="mod_benvenuto_content">
                                                ...
                                                <script>
                                                    $(document).ready(function(){ 
                                                        $("#modifica'.$row['id'].'").on("click",function(){
                                                            $("#ModaleUpBenvenuto'.$row['id'].'").modal("show"); 
                                                        });
                                                    });
                                                </script>                                               
                                            </div>
