	...
	foreach($rec as $key => $row){
				...
				$riepilogoModal .=	'<div class="modal fade" id="proposta'.$row['Id'].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
								...
								$data[] = array(
									...
									"action"         => '<a href="javascript:validator_ri_abilita(\''.BASE_URL_SITO.'ri_attiva_disdetta/'.$row['Id'].'\');" title="Ri Attiva"><i class="fa fa-repeat fa-2x fa-fw" aria-hidden="true"></i></a>'
