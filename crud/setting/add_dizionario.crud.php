...
include($_SERVER['DOCUMENT_ROOT']."/include/function.inc.php");
	...
	foreach($rec as $key => $row){
                        ...
                        $modale = '<div class="modal fade" id="ModaleUpdateTestoDizionario'.$row['id'].'" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content" style="width:100%">
                                                    ...
                                                    <div class="modal-body  p-l-50 p-r-50">
                                                                    ...
                                                                    <form method="POST" id="form_up_dizionario'.$row['id'].'" name="form_up_dizionario" method="POST" action="'.BASE_URL_SITO.'ajax/generici/modifica_testo_dizionario.php">
                            ...
                            $modale .=                                   '<div class="form-group">  
                                                                            <div class="row">
                                                                                <div class="col-md-12 text-center">
                                                                                    ...
                                                                                    <input type="hidden" name="action"  value="mod_dizionario">
                                                ...
                                                <script>
                                                    $(document).ready(function(){ 
                                                        $("#modifica'.$row['id'].'").on("click",function(){
                                                            $("#ModaleUpdateTestoDizionario'.$row['id'].'").modal("show"); 
                                                        });
                                                    });
                                                </script>                                               
                                            </div>
