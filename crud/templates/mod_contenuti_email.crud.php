                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form id="form_up_content'.$row['id'].'" name="form_up_content" method="POST" action="'.BASE_URL_SITO.'ajax/templates/modifica_altri_contenuti_email.php">'."\r\n";                                          
                                if($row['textarea']==0){                                
                                    ...
                                    $modale .= '            <div class="form-group">  
                                                                <div class="row">
                                                                    <div class="col-md-12 text-center">
                                                                        ...
                                                                        <input type="hidden" name="action"  value="mod_contenuto_email">
