...
include($_SERVER['DOCUMENT_ROOT']."/include/function.inc.php");
	...
	$select  = "SELECT 
					hospitality_minigallery.*	
				FROM 
					hospitality_minigallery 
				WHERE 
					hospitality_minigallery.idsito = ".$_REQUEST['idsito']."";
                                ...
                                <div class="modal-body">
                                    ...
                                    $(document).ready(function() {
                                        ...
                                        $("#form_mod_galleria'.$row['Id'].'").submit(function () {  
                                            ...
                                            $.ajax({
                                                url: "'.BASE_URL_SITO.'ajax/templates/modifica_immagine.php",
                                                type: "POST",
                                                data: "action=mod_img&idsito='.$row['idsito'].'&Immagine="+Immagine+"&Id="+Id+"",
                                                dataType: "html",
                                                success: function(data) {
                                                    $("#ModaleUpdateGalleria'.$row['Id'].'").modal("hide");
                                                    $("#mini_gallery").DataTable().ajax.reload();    
                                                }
                                            });
