...
if ($_REQUEST['form_fields']['action'] == 'send') {
  ...
  */
  ...
  rtrim($dati, '&');
  /**
   * * valorizzazione della user e pass per accedere al file (api_form_elementor.php) protetto
  */
  $user = 'quoto';
  $pass = 'lHxAbMHGU';
  /**
  ...
  */
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, 'https://www.quotocrm.it/ApiFormQuoto/api_form_elementor.php');
  ...
  */
  echo 'C\'E\' QUALCHE PROBLEMA CONTATTA l\'AMMINISTRATORE DEL TUO SITO!';
}
