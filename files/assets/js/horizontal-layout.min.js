    ...
    $(".pcoded-navbar .pcoded-hasmenu").attr("subitem-icon", "style1"), $("#pcoded").pcodedmenu({
        ...
        function() {
            $(".theme-color > a.navbar-theme").on("click", function() {
                ...
                $(".pcoded-navbar").attr("navbar-theme", e), $(".navbar-logo").attr("navbar-theme", e)
            })
        }(),
        function() {
        ...
        function() {
            $("#theme-layout").val("wide").on("change", function(e) {
                e = $(this).val(), $(".pcoded").attr("horizontal-layout", e)
            })
        }(),
        function() {
            $("#navbar-placement").val("top").on("change", function(e) {
                e = $(this).val(), $(".pcoded").attr("horizontal-placement", e)
            })
        }(),
        function() {
        ...
        function() {
            $("#sidebar-position").change(function() {
                $(this).is(":checked") ? $(".pcoded-navbar").attr("pcoded-navbar-position", "fixed") : $(".pcoded-navbar").attr("pcoded-navbar-position", "relative")
            })
        }(),
        function() {
            $("#menu-icons").change(function() {
                $(this).is(":checked") ? $('.pcoded .pcoded-navbar .pcoded-item > li > a .pcoded-micon:not(".pcoded-search-item .pcoded-micon")').hide() : $('.pcoded .pcoded-navbar .pcoded-item > li > a .pcoded-micon:not(".pcoded-search-item .pcoded-micon")').show()
            })
        }(),
        function() {
            $("#brand-visibility").change(function() {
                $(this).is(":checked") ? $(".pcoded .pcoded-navbar .pcoded-brand").hide() : $(".pcoded .pcoded-navbar .pcoded-brand").show()
            })
        }(),
        function() {
            $("#leftitem-visibility").change(function() {
                $(this).is(":checked") ? $(".pcoded .pcoded-navbar .pcoded-item.pcoded-left-item").hide() : $(".pcoded .pcoded-navbar .pcoded-item.pcoded-left-item").show()
            })
        }(),
        function() {
            $("#rightitem-visibility").change(function() {
                $(this).is(":checked") ? $(".pcoded .pcoded-navbar .pcoded-item.pcoded-right-item").hide() : $(".pcoded .pcoded-navbar .pcoded-item.pcoded-right-item").show()
            })
        }(),
        function() {
            $("#searchitem-visibility").change(function() {
                $(this).is(":checked") ? $(".pcoded .pcoded-navbar .pcoded-item.pcoded-search-item").hide() : $(".pcoded .pcoded-navbar .pcoded-item.pcoded-search-item").show()
            })
        }(),
        function() {
            $("#branditem-align").val("left").on("change", function(e) {
                e = $(this).val(), "left" === e ? ($(".pcoded-navbar .pcoded-brand").removeClass("pcoded-right-align"), $(".pcoded-navbar .pcoded-brand").addClass("pcoded-left-align")) : ($(".pcoded-navbar .pcoded-brand").addClass("pcoded-right-align"), $(".pcoded-navbar .pcoded-brand").removeClass("pcoded-left-align"))
            })
        }(),
        function() {
            $("#leftitem-align").val("left").on("change", function(e) {
                e = $(this).val(), "left" === e ? ($(".pcoded-navbar .pcoded-left-item").removeClass("pcoded-right-align"), $(".pcoded-navbar .pcoded-left-item").addClass("pcoded-left-align")) : ($(".pcoded-navbar .pcoded-left-item").addClass("pcoded-right-align"), $(".pcoded-navbar .pcoded-left-item").removeClass("pcoded-left-align"))
            })
        }(),
        function() {
            $("#rightitem-align").val("left").on("change", function(e) {
                e = $(this).val(), "left" === e ? ($(".pcoded-navbar .pcoded-right-item").removeClass("pcoded-right-align"), $(".pcoded-navbar .pcoded-right-item").addClass("pcoded-left-align")) : ($(".pcoded-navbar .pcoded-right-item").addClass("pcoded-right-align"), $(".pcoded-navbar .pcoded-right-item").removeClass("pcoded-left-align"))
            })
        }(),
        function() {
            $("#searchitem-align").val("left").on("change", function(e) {
                e = $(this).val(), "left" === e ? ($(".pcoded-navbar .pcoded-search-item").removeClass("pcoded-right-align"), $(".pcoded-navbar .pcoded-search-item").addClass("pcoded-left-align")) : ($(".pcoded-navbar .pcoded-search-item").addClass("pcoded-right-align"), $(".pcoded-navbar .pcoded-search-item").removeClass("pcoded-left-align"))
            })
        }()
}), handlemenutype("st2");