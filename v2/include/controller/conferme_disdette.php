...
if($_REQUEST['azione']!='' && $_REQUEST['param']=='delete'){
    ...
    $xcrud->columns('ChiPrenota,NumeroPrenotazione,FontePrenotazione,TipoVacanza,DataRichiesta,Nome,Email,Lingua,DataArrivo,DataPartenza,NumeroAdulti,NumeroBambini,Proposte,DataInvio,Id,idsito,NoDisponibilita', false);
    ...
    $xcrud->column_class('ChiPrenota,Email,Proposte,Provenienza,idsito,NumeroAdulti,NumeroBambini,Id', 'align-center');
    ...
    $xcrud->button('javascript:;','Ri Abilita la conferma','icon-checkmark fa fa-minus-circle text-green','');
