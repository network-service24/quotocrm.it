						...
						$form[$k] = get_form_new($id_form,IDSITO,$k,'');	
                           	...
                           	$rnd_id = 'id'.date('Ymdhis').rand(0,999999);          
                                $content.= '<div class="panel box box-success">
                                            ...
                                            <div style="height: 0px;" id="collapse'.$v.'" class="panel-collapse collapse">
                                             <div class="box-body">';
                              ...
                              <input type="hidden" name="id_lang" id="id_lang" value="'.$k.'">';                                             
                                ...
                                if(isset($form[$k]['content'])){
                                     ...
                                     $content.= '<div class="row">
                                                    <div class="col-md-12"><h2>Gestione dei Campi</h2></div>
                                                    </div>
                                                    <div class="row">
                                                    <div class="col-md-12">
	...
	$record = get_content_testata_form($id_form,IDSITO);
 	...
 	$content_setting .='
						<div class="panel box box-success">
							...
							<div style="height: 0px;" id="collapseReCaptcha" class="panel-collapse collapse">
								<div class="box-body">
									...
									<form method="post" id="form_setting_form" name="form_setting_form">
										...
										<h2>Inserire i valori per il google recaptcha</h2>										
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
