                    ...
                    if($acconto!=''){
                        ...
                        if($AccontoTariffa !='' || $AccontoTesto!=''){
                            $sistemazione .= '<tr>
                                                ...
                                                <span style="font-size:10px">'.nl2br((strlen($AccontoTesto>=220)?strip_tags($AccontoTesto):substr(strip_tags($AccontoTesto),0,220).'...')).'</span></td>
                                            </tr>';
                        }
...
$html2pdf->output(BASE_PATH_SITO.'uploads/'.IDSITO.'/'.$print_pdf.'.pdf');
