...
/*     $marzo              = mktime(24,0,0,03,01,2020);
    ...
    $sel_color = "SELECT * FROM hospitality_template_background WHERE idsito = ".IDSITO." AND TemplateType = 'custom3' LIMIT 1";
...
$proposta_conteggio .='  <div class="ca1 bcolor"></div>
  ...
  if($AccontoPercentuale == 0 && $AccontoImporto != 0) {
    ...
    $q_Gallery  = "SELECT Id FROM hospitality_tipo_gallery WHERE TargetType = 'custom3' AND idsito = ".IDSITO." AND Abilitato = 1 ";
