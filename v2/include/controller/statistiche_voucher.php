...
if($_REQUEST['DataRiconferma']!=''){   
    ...
    if($totale>0){   
        $legenda .= '<div style="float:right"><a href="javascript:;" id="attiva_legenda" data-toogle="tooltip" title="" class="h4" data-original-title="Clicca per leggere!">Help <i class="fa fa-life-ring text-info" aria-hidden="true"></i></a></div>
                  ...
                  <div class="clearfix"></div>'."\r\n";  
        $legenda .= '<table class="table table-responsive table-bordered bordo-tabella">
                            <tr>
        ...
        foreach($arr_result as $key => $record){
            ...
            foreach($array_record as $key => $rec){
                ...
                #totale caparre
                    $TotaleC  = ($acconto!=''?$acconto+$TotaleC:0);
...
if($_REQUEST['DataRiconferma']!=''){   
    ...
    if($totaleN>0){
        ...
        $legendaN .= '<table class="table table-responsive table-bordered bordo-tabella">
                            <tr>
