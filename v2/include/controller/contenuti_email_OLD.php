<?php
  ...
  /* subselect per visualizzare le icone delle lingue relative ai testi presenti */
    ...
    $diz_langD->field_callback('testo','textarea_input');
  ...
  /* subselect per visualizzare le icone delle lingue relative ai testi presenti */
    ...
    $diz_langCK->field_callback('testo','textarea_input');
  ...
  /* subselect per visualizzare le icone delle lingue relative ai testi presenti */
    ...
    $diz_langDispo->field_callback('testo','textarea_input');
  ...
  /* subselect per visualizzare le icone delle lingue relative ai testi presenti */
    ...
    $diz_langAnnulla->field_callback('testo','textarea_input');
  ...
  /* subselect per visualizzare le icone delle lingue relative ai testi presenti */
    ...
    $diz_langAnnullaP->field_callback('testo','textarea_input');
    ...
    $xcrud2->change_type('Immagine', 'image', '', array('manual_crop' => true,'width' => 400,'ratio' => 2, 'path' => BASE_PATH_SITO."uploads/".IDSITO.'/'));
