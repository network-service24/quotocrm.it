    ...
    if($totCampn>0){
     ...
     $preno_chiuse      = '';
        ...
        foreach ($rws9n as $key9n => $value9n) {
            ...
            $numero_landing    = numero_campagne_da_landing2(IDSITO,'facebook',$value9n['Campagna'],$ClientId);
            $numero_sito       = numero_campagne_da_sito2(IDSITO,'facebook',$value9n['Campagna'],$ClientId);
      ...
      $legendaSn_BOX .= '<tr>
                            ...
                            <td></td>  
                            <td></td>
                            <td class="text-right wrap"><i class="fa fa-euro"></i>  '.number_format($totaleFBn,2,',','.').'</b></td>
                        </tr>';      
    $legendaSn_BOX .= '</table>';
