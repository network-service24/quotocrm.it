<?php
    ...
    $xcrud->table('hospitality_giorni_recall_conferme');
    $xcrud->where('hospitality_giorni_recall_conferme.idsito', IDSITO);                    
    ...
    $xcrud2->table('hospitality_giorni_recall_conferme');
    $xcrud2->where('hospitality_giorni_recall_conferme.idsito', IDSITO);                    
    ...
    $xcrud2->table_name('<small>Scegliere quanti  giorni prima della Scadenza deve ripartire automaticamente l\'email di conferme in attesa</small>');
    $xcrud2->unset_print();
    $xcrud2->unset_add();
    $xcrud2->unset_remove();
    $xcrud2->unset_view();
    ...
    $xcrud_resend->where('hospitality_dizionario.etichetta = "TESTOMAIL_RESEND_CONFERMA" OR hospitality_dizionario.etichetta = "OGGETTO_RESEND_CONFERMA"');
  ...
  /* subselect per visualizzare le icone delle lingue relative ai testi presenti */
    ...
    $xcrud_resend->table_name('<small>Contenuti email: di ReSend di Conferme in attesa!</small>');
