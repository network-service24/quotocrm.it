<?php
    ...
    $xcrud->table('hospitality_giorni_cs');
    $xcrud->where('hospitality_giorni_cs.idsito', IDSITO);                    
    ...
    $xcrud2->table('hospitality_giorni_cs');
    $xcrud2->where('hospitality_giorni_cs.idsito', IDSITO);                    
    ...
    $xcrud2->table_name('<small>Scegliere quanti  giorni PRIMA o DOPO il Check Out deve partire automaticamente l\'email di Customer Satisfaction (Questionario)</small>');
    $xcrud2->unset_print();
    $xcrud2->unset_add();
    $xcrud2->unset_remove();
    $xcrud2->unset_view();
    ...
    $xcrud_reselling->where('hospitality_dizionario.etichetta = "TESTOMAIL" OR hospitality_dizionario.etichetta = "OGGETTO"');
  ...
  /* subselect per visualizzare le icone delle lingue relative ai testi presenti */
    ...
    $xcrud_reselling->table_name('<small>Contenuti email: del Questionario (Customer Satisfaction)!</small>');
