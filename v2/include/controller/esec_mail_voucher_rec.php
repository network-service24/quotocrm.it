...
$DataValiditaVoucher_tmp     = explode("/",$_REQUEST['DataValiditaVoucher']);
...
$risultato = $db->query($qry);
$value = $db->row($risultato);
...
if($_REQUEST['action']=='send_email_voucher_rec'){
    ...
    if (!$mail->send()) {
        ...
        $prt->_goto(BASE_URL_SITO.'buoni_voucher/disd_rec/ok'); 
    }                 
