<?php
    ...
    $TipoListino->button('javascript:validator(\''.BASE_URL_SITO.'delete_listino/{idsito}/{id}/\');','Elimina Listino','glyphicon glyphicon-remove','btn btn-default btn-sm bg-red',array('data-toogle'=>'tooltip'));
    $TipoListino->unset_view();
    ...
    $listino->button('javascript:;','Duplica','icon-checkmark glyphicon glyphicon-plus','',array('onclick' => 'duplicator(\''.BASE_URL_SITO.'duplica_listino/{Id}/{IdCamera}/sum/\')','data-toogle'=>'tooltip'));
