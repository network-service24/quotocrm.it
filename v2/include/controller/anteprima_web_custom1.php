...
/*     $marzo              = mktime(24,0,0,03,01,2022);
    $marzo2             = mktime(01,0,0,03,31,2022);
    $aprile             = mktime(24,0,0,04,01,2022);
    $aprile2            = mktime(01,0,0,04,30,2022);
    ...
    $sel_color = "SELECT * FROM hospitality_template_background WHERE idsito = ".IDSITO." AND TemplateType = 'custom1' LIMIT 1";
...
$proposta_conteggio .='  <div class="ca1 bcolor"></div>
  ...
  if($AccontoPercentuale == 0 && $AccontoImporto != 0) {
    ...
    $q_Gallery  = "SELECT Id FROM hospitality_tipo_gallery WHERE TargetType = 'custom1' AND idsito = ".IDSITO." AND Abilitato = 1 ";
