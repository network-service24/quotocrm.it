                                                      ...
                                                      <div class="col-md-4">
                                                          ...
                                                          <div class="col-md-4">
                                                              <div class="form-group">
                                                                ...
                                                                <input type="text" id="DataRichiesta_dal" autocomplete="off"  class="date-picker form-control" name="DataRichiesta_dal" value="'.$_REQUEST['DataPrenotazione_dal'].'">
                                                              </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                              <div class="form-group">
                                                                  <label class="control-label">Data Richiesta Al <small style="font-weight:normal!important">(<=)</small></label>
                                                                  <input  type="text" id="DataRichiesta_al" autocomplete="off"  class="date-picker form-control" name="DataRichiesta_al" value="'.$_REQUEST['DataPrenotazione_al'].'">
                                                              </div>
                                                          </div>
                                                          <div class="col-md-2"></div>
                                                        </div>
...
/*         if($_REQUEST['TipoRichiesta']!=''){
    ...
    $xcrud->columns('NumeroPrenotazione,TipoRichiesta,FontePrenotazione,TipoVacanza,Nome,Email,Lingua,DataArrivo,DataPartenza,DataChiuso,Chiuso,CS_Inviato,Disdetta,Id,Ip', false);
    ...
    $xcrud->column_callback('Chiuso','si_no');
