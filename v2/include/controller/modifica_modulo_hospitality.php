<?php
    ...
    $sel_sc = $db->query("SELECT CodiceSconto FROM hospitality_guest WHERE Id = ".($_REQUEST['param']==''? $_REQUEST['Id'] : $_REQUEST['param'])." ");
    $datirecord = $db->row();
    ...
    if($CodiceSconto != ''){
        ...
        $res_cod_sconti       = $db->query($select_codice_sconto);
        $arr_cod_sconti       = $db->row($res_cod_sconti);
        if(is_array($arr_cod_sconti)) {
            if($arr_cod_sconti > count($arr_cod_sconti))
    ...
    if($_GET['azione'] == 'edit' && $_GET['param'] != '') {
                                                ...
                                                <tr>
                                                    <td colspan="6" class="nopadding no-border-top">
                                                        ...
                                                        <div  class="box-header">
                                                            ...
                                                            <div style="float:right;"><a href="javascript:;" id="attiva_legenda_servizi_new'.$n.'" data-toogle="tooltip" title="" data-original-title="Clicca per leggere!">Help <i class="fa fa-life-ring text-info" aria-hidden="true"></i></a></div>
                                                            <div class="clearfix"></div>
                                                            <div id="legenda_servizi_new'.$n.'" style="display:none">
                                                                ...
                                                                <div class="clearfix"></div>
                                                                <i class="fa fa-exclamation-triangle text-orange" aria-hidden="true"></i> <small class="pdL20">Per modificare i servizi aggiuntivi  abilitati durante la creazione del preventivo o dopo la duplicazione di un preventivo, cliccate sulla <b class="text-orange">X</b> corrispondete! (Ricordatevi di aggiornare il prezzo totale del soggiorno, semplicemente cliccando sul campo)</small>
                                                                <div class="clearfix"></div>
                                                            ...
                                                            <script>
                                                                $(document).ready(function(){
                                                                    $("#attiva_legenda_servizi_new'.$n.'").on("click",function(){
                                                                        $("#legenda_servizi_new'.$n.'").slideToggle("slow");
                                                                    })
                                                                })
                                                            </script> 
                                                        </div>
        ...
        function get_modifica_servizi_aggiuntivi($n,$id_richiesta,$id_proposta){
            global $db,$Notti,$NumeroPrenotazione;
                ...
                if(sizeof($record)>0){
                                                    ...
                                                    <td colspan="6" class="nopadding no-border-top">
                                                        ...
                                                        <div  class="box-header">
                                                            ...
                                                            <div id="legenda_servizi'.$n.'" style="display:none">
                                                                ...
                                                                <i class="fa fa-question text-info" aria-hidden="true"></i> <small class="pdL20">Se il <b>servizio viene eliminato</b>, (dopo essere stato calcolato), <b>passare con il cursore del mouse</b> sul campo <b>"Prezzo Soggiorno"</b></small>
                                                                <div class="clearfix"></div>
                                                                <i class="fa fa-question-circle text-info" aria-hidden="true"></i> <small class="pdL20">Se un <b>servizio viene scelto</b> dal cliente, automaticamente verrà colorato di verde per distinguerlo dai servizi scelti dal operatore in fase di preventivo</small>
                                                                </div>
                                                            <script>
                                                                $(document).ready(function(){
                    ...
                    foreach($record as $chiave => $campo){
                        ...
                        $rs  = $db->row($ss);
                                        ...
                                        $lista_servizi_aggiuntivi .='<tr class="contenitore_servizio'.$n.'">
                                                                        <td class="td5pdl0pdr10 no-border-top padding2">'.($campo['Icona']!=''?'<div class="content_icona"><img src="'.BASE_URL_ROOT.'uploads/'.IDSITO.'/'.$campo['Icona'].'" class="iconaDimension"></div>':'<div class="content_icona_empty"></div>').'</td>
                                                                        <td class="td20pdl0pdr10 no-border-top padding2"><b '.((!$IdServizioScelto[$campo['Id']] && $IdServizio[$campo['Id']]==1)?'class="text-olive" data-toogle="tooltip" title="Servizio scelto dal cliente"':'').' >'.$campo['TipoServizio'].'</b></td>
                                                                        <td class="td20pdl0pdr10 no-border-top padding2"><small>'.(strlen($rec['Descrizione'])<=80?stripslashes(strip_tags($rec['Descrizione'])):substr(stripslashes(strip_tags($rec['Descrizione'])),0,80).'...').'</small></td>
                                ...
                                if($campo['CalcoloPrezzo'] == 'A percentuale' && $campo['PercentualeServizio'] != ''){ 
                                    ...
                                    if($campo['CalcoloPrezzo'] == 'A persona'){ 
                                        $lista_servizi_aggiuntivi .='       <div id="contenitore_switchery'.$recrel['id_relazionale'].'">
                                                                            <div style="display:inline;width:100%" class="nowrap"><span  style="position:absolute;right:100px"><small><a href="javascript:;" data-toogle="tooltip" title="Clicca sul HELP"><i class="fa fa-question"></i></a></small></span><input type="checkbox" class="js-switch PrezzoServizio'.$n.'" id="PrezzoServizio'.$n.'_'.$campo['Id'].'" name="PrezzoServizio'.$n.'['.$campo['Id'].']" value="'.$campo['PrezzoServizio'].'#'.$campo['CalcoloPrezzo'].'#'.$campo['Id'].'" '.($IdServizio[$campo['Id']]==1?'checked="checked"':'').' '.($campo['Obbligatorio']==1?'checked="checked"':'').'></div>';
                                    }else{
                                        $lista_servizi_aggiuntivi .='       <div id="contenitore_switchery'.$recrel['id_relazionale'].'">
                ...
                foreach($rec as $ch => $vl){
                  ...
                  if($tot2==0){
                      ...
                      $TipiPagamento .='
                                      ...
                                      '.($vl['TipoPagamento']=='Stripe'?'<td class="text-center no_border_top no_padding"><b>Stripe</b><br><input type="checkbox" class="js-switch" value="1" '.($rec2['GBS']==1?'checked="checked"':'').' name="GBS" id="GBS"><br><input style="display:none" class="form-control" placeholder="Copia ed incolla il link creato da STRIPE" type="text" name="linkStripe" id="linkStripe" value="'.$rec2['linkStripe'].'"></td>':'').'
                    ...
                    if($TipoRichiesta=='Preventivo'){
                            ...
                            if(check_ericsoftbooking(IDSITO)==1){
                                $proposte  .=    '<div class="row">
                                                   <div class="col-md-1"></div>
                                                   <div class="col-md-10 text-center">
                                                   <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input_ericsoft_booking'.$i.'">Apri <img src="'.BASE_URL_SITO.'img/powered-ericsoftb-bc.png"  style="text-align:absmiddle;width:auto;height:15px"></button>
                                                       <div id="wait'.$i.'"></div>
                                                   </div>
                                                   <div class="col-md-1"></div>
                                               </div>';
                                        ...
                                        if($DataRichiesta>DATA_QUOTO_V2){
                                            ...
                                            $proposte  .= '                        </select>
                                                                        ...
                                                                        <td class="td25pdl0pdr10 no-border-top">
                                                                            <div class="form-group">
                                                                                <select name="TipoCamere'.$i.'[]"  id="TipoCamere_'.$i.'_'.$num_righe.'" class="'.$stile_chosen.'form-control" '.((check_simplebooking(IDSITO)==0 && check_ericsoftbooking(IDSITO)==0  && check_bedzzlebooking(IDSITO)==0)?'onChange="get_listino('.$i.','.$num_righe.');"':'').'>';
                                                                                $db->query("SELECT * FROM hospitality_tipo_camere WHERE  Abilitato = 1 AND idsito = ".IDSITO." ORDER BY Ordine ASC");
                                                                                $rw = $db->result();
                                                                                $ListaCamere = '';
                                                                                foreach($rw as $key => $v){
                                                                        ...
                                                                        <td class="td9pdl0pdr10 no-border-top">
                                                                            <div class="form-group">
                                                                                <select name="NumAdulti'.$i.'[]" id="NumeroAdulti_'.$i.'_'.$num_righe.'"
                                                                                    class="form-control" tabindex="20" '.((check_simplebooking(IDSITO)==0 && check_ericsoftbooking(IDSITO)==0  && check_bedzzlebooking(IDSITO)==0)?'onChange="get_listino('.$i.','.$num_righe.');"':'').'>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="input-group" style="width:100%">
                                                                                    ...
                                                                                    <input type="text" name="Prezzo'.$i.'[]" id="Prezzo_'.$i.'_'.$num_righe.'"
                                                                                        ...
                                                                                        placeholder="Prezzo 0000.00" tabindex="23"  '.((check_simplebooking(IDSITO)==0 && check_ericsoftbooking(IDSITO)==0  && check_bedzzlebooking(IDSITO)==0)?'onfocus="get_listino('.$i.','.$num_righe.');"':'').' onmouseout="calcola_totale'.$i.'();">';
                                                if($TipoRichiesta=='Preventivo'){
                                    ...
                                    if($DataRichiesta>DATA_QUOTO_V2){
                                        ...
                                        $proposte .='<table class="table table-responsive">
                                                            <tr>
                                                                ...
                                                                <div style="float:right; margin-right:180px;background-color:#FF3333;color:#FFFFFF!important;'.($CodiceSconto != ''?'padding:10px;':'').'" class="nowrap"><small>'.($CodiceSconto != ''  && $check_codice_sconto == true  ? '<b>E\' stato applicato il codice sconto ['.$CodiceSconto.']</b>' : '').'</small></div> 
                                                                <td class="col-md-2">
                    ...
                    $n_camere = count($_REQUEST['TipoCamere1']);
                     for($i=0; $i<=($n_camere-1); $i++){
                        ...
                        ######################################### ARRAY UTILE AL CURL PER ANALITICS####################################         
                            ...
                            $formato="%a";
                            $GA4Notti = dateDiff($DataArrivo1,$DataPartenza1,$formato);
                        ...
                        // ##############CURL VERSO ANALYTICS PER IMPUTARE I DATI DI QUOTO IN ANALYTICS##############
                            ...
                            if($_REQUEST['FontePrenotazione']== 'Sito Web'){
                                ...
                                $dati_analytics   = get_account_analytics($_REQUEST['idsito']);
            ...
            /*                         $CLIENT_ID_GA4_ = explode(".",$CLIENT_ID);
                                    ...
                                    $CLIENT_ID_GA4  = $CLIENT_ID;
                                        ...
                                        $stringa_dati = array("client_id"  => $CLIENT_ID_GA4,
                                                                ...
                                                                "affiliation" => "quoto",
                                                                "currency" => "EUR",
                                                                "transaction_id" => 'QUOTO_'.$_REQUEST['NumeroPrenotazione'],
