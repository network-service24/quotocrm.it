 ...
 $sqln = "SELECT hospitality_tracking_ads.NumeroPrenotazione
    ...
    if($totCampn>0){
        ...
        foreach($array_campagnen as $k => $vl){
            ...
            $legendaSn_BOX2 = '<tr>
                                    <td class="text-left wrap">'.str_replace("http://","",$vl).'</td>
                                    <td class="text-center">'.numero_campagne_da_(IDSITO,'google',$vl,'landing').'</td>   
                                    <td class="text-center">'.numero_campagne_da_(IDSITO,'google',$vl,'sito').'</td>  
        ...
        foreach ($array_fatturatoSn as $yn => $valn) {
            ...
            if($valn!="" || $valn != 0){
                ...
                $legendaSn_BOX .= '<tr>
                                        ...
                                        <td class="text-center">'.numero_campagne_da_(IDSITO,'google',$yn,'landing').'</td>   
                                        <td class="text-center">'.numero_campagne_da_(IDSITO,'google',$yn,'sito').'</td>  
                                        <td class="text-center">'.n_campagne_chiuse(IDSITO,'google',$yn).'</td>
