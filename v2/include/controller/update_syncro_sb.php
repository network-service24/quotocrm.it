                        ...
                        foreach ($val as $k => $v) {
                          switch($v['MealPlanCode'][0]){
                            ...
                            if($v['MealPlanCode'][0]!=''){
                                ...
                                $sel1 = $db->query("SELECT * FROM hospitality_tipo_soggiorno WHERE idsito = '".IDSITO."' AND Lingua = 'it' AND PlanCode = '".$v['MealPlanCode'][0]."' AND Abilitato = 1");
        ...
        if(sizeof($Tcheck)>0){
                ...
                $RoomCode = '';
                    ...
                    foreach ($camera as $y => $rec) {
                          ...
                          $selcam1 = $db->query("SELECT * FROM hospitality_tipo_camere WHERE idsito = '".IDSITO."' AND Lingua = 'it' AND RoomCode = '".$rec['RoomCode']."' AND Abilitato = 1");
