    ...
    <section class="content">
        <div class="box radius6">
            <div class="box-body">
                <h2>
                  <div class="row">
                      ...
                      <div class="col-md-3 text-right">
                        <small><a href="<?=BASE_URL_SITO.'grafici-statistiche/'?>"><i class="fa fa-refresh"></i> reset filtri</a></small>
                      </div>
                ...
                <div class="text-center"><p>Filtrando i risultati <b>per anno</b> e scegliendo un <b>anno inferiore al 2021</b>, si verrà rediretti al <b>al metodo tradizionale di elaborazione dati</b>!<br>Invece  <b>sulle date di confronto</b> NON si viene rediretti, ma si rimane sulla schermata d'ingresso!</p></div>
              <div id="avanzati">
                <div class="clearfix"></div>
                        <div class="row">
                          <div class="col-md-12">
                            <small><i class="fa fa-arrow-down" style="padding-top:20px"></i> Confronta le date di arrivo e le date di partenza;
                      ...
                      <div class="row">
                          <div class="<?=($split_graph == true?'col-md-6 col-sm-6 col-xs-6':'col-md-12 col-sm-12 col-xs-12')?>">
                                ...
                                <?if(!empty($array_fatturatoS) || !is_null($array_fatturatoS)){?>
                                          ...
                                          <div class="box no-radius">
                                            <div class="box-header with-border">
                                            <h4 id="blink_stat" class="text-center"><b>[Nuovo Modulo]</b></h4>
                                              <script>        
                                                  $(document).ready(function() {
                                                      var i = 0;
                                                      var speed = 500;
                                                      link = setInterval(function() {
                                                          i++;
                                                          $("#blink_stat").css('color', i%2 == 1 ? '#DD4B39' : '#2C3B41');
                                                      },speed);
                                                  });
                                              </script>
                                              <h3 class="box-title"><b>Dettaglio</b> della <b>somma fatturato</b> con fonte di prenotazione <b>Sito Web</b> e <b>Landing Page</b> </h3>
                                              <div class="box-title">
                                                  <small>Suddivisione per provenienza: se deriva da una campagna social, un Pay x Click, da un risultato di indicizzazione organica, da una richiesta proveniente da una landing page dedicata, oppure da una entrata diretta nel vostro sito.</small>
                                                  <div id="blink_fatturatoS" class="text-center" style="width:100%!important;margin-top:10px"><small><b>Metodo con API Analytics</b></small></div>
                                              </div>
                                              <div class="box-tools pull-right">
                                          ...
                                          <div class="box no-radius">
                                            <div class="box-header with-border">
                                              ...
                                              <div class="box-title">
                                                  ...
                                                  <div id="blink_fatturatoS2" class="text-center" style="width:100%!important;margin-top:10px"><small><b>Metodo con API Analytics</b></small></div>
                                              </div>
                                              <div class="box-tools pull-right">
                                                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                                                </button>
