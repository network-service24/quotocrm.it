...
<div class="content-wrapper">
    ...
    <section class="content">
                <div class="alert alert-profila  alert-default-profila alert-dismissable text-center text-black">    
                    <p><b>LEGENDA:</b> le prenotazioni e/o ..in trattativa se <b>cestinate</b> da qualsiasi modulo statistico!</p>
            ...
            <div class="box radius6">
                ...
                <?= $js_load ?>
                <h4 class="text-center"><img src="<?=BASE_URL_SITO?>img/gads.png" style="width:32px;height:32px"/>  Fonte di prenotazione <b>Google Ads</b>: per campagne social. <small>(tracciabilità ottenuta da UTM QUOTO)</small></h4>                           
                <div class="row">
