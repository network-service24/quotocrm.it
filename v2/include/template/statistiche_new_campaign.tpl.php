...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <h1>Statistiche di dettaglio metodo <strong><?php echo $method ?></strong> canale <strong><?php echo $channel ?></strong></h1>
...
<script>
    j(function () {
        ...
        function updateChart(isCompare, start, end) {
            ...
            j.post({
                url: '<?php echo BASE_URL_SITO ?>ajax/statistiche_new_graph_campaign.php',
                data: {
...
/*         function updateTableAnnulled(isCompare, start, end) {
        ...
        j('body').on('click', '.show-detail', function () {
            ...
            j('#modal-details-table').DataTable({
                ajax: '<?php echo BASE_URL_SITO ?>ajax/statistiche_new_details_campaign.php/?' + encodeQueryData(params),
                destroy: true,
                columns: [
                    {title: "Id"},
