                      ...
                      <div class="row">
                        ...
                        <div class="col-md-1">
                            <form id="form_export" method="post" name="form_export" action="<?=BASE_URL_SITO?>include/controller/export_disdette_quoto.php">
                                ...
                                <a href="#" class="btn btn-info btn-xs" onclick="document.getElementById('form_export').submit();" id="pulsante_esporta"><i class="fa fa-file-excel-o" aria-hidden="true"></i> <span style="margin-left: 10px!important;">Esporta CSV</span></a>
                            </form>
                        </div>
                        <div class="col-md-7">           
