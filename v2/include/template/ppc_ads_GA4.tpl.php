...
<div class="content-wrapper">
    ...
    <section class="content">
                <div class="alert alert-profila  alert-default-profila alert-dismissable text-center text-black">    
                    ...
                    <p>La <b>sincronizzazione</b> dei dati con <b>Analytics GA4</b> ha <b>48 ore di scarto</b>, per esempio: se un preventivo e/o una prenotazione proveniente da "Sito Web -> campagna google cpc" entrata il 01-00-0000 sarà visibile nel modulo statistico di GA4 il 03-00-0000</p>                                                                 
            ...
            <div class="box radius6">
                ...
                <?= $js_load ?>
                <h4 class="text-center"><img src="<?=BASE_URL_SITO?>img/gads.png" style="width:32px;height:32px"/>  Fonte di prenotazione <b>Google Ads</b>: per campagne social. <small>(tracciabilità ottenuta da Analytics GA4)</small></h4>                           
                <div class="row">
