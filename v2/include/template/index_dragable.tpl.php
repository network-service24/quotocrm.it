    ...
    <section class="content">
            ...
            <?//}?>
              <div class="grid-stack" data-gs-width="12" data-gs-animate="yes">
                      ...
                      <div class="grid-stack-item" data-gs-x="8" data-gs-y="2" data-gs-width="2" data-gs-height="2">
                          <div class="grid-stack-item-content">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12 ">
                                <div class="box radius6 col-eq-height animated zoomIn">
                                      ...
                                      <?=fatturato_post_upselling()?>
                                            ...
                                            <div class="grid-stack-item" data-gs-x="0" data-gs-y="12" data-gs-width="12" data-gs-height="8">
                                                <div class="grid-stack-item-content">
