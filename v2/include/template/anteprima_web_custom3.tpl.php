          ...
          <div class="box radius6 smart">
            <div class="box-body">
                ...
                <div class="col-md-12 text-center" style="font-size:22px!important;border-bottom:0px!important;color:#FFFFFF!important">                            
                    <i class="fa fa-windows"></i> Anteprima Landing page <b><?=ucwords(get_name_template(IDSITO,'custom3'))?></b> di Preventivo e/o Conferma   <small style="font-size:50%">(FAC SIMILE, NON IMPUTABILE)</small> 
                    <?  
                      if($_REQUEST['azione']==''){
