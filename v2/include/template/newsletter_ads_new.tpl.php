                                    ...
                                    $(document).ready(function(){
                                        $("#pul_search_date").on("click",function(){
                                            ...
                                            if(parseInt(dal_[2]) < 2021){
                                                $("#relation_requestdate").attr('action','<?=BASE_URL_SITO?>grafici-newsletter_ads_new/')
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="box no-radius">
                            <div class="box-header with-border">
                                <h3 class="box-title">Fonte di prenotazione <b>Newsletter Ads</b> <img src="<?= BASE_URL_SITO ?>img/analytics.png" style="width:32px;height:32px"/>: per campagne.</h3>
                                <div class="box-tools pull-right">
