...
<div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="box radius6">
                ...
                <?= $js_load ?>
                <h4 class="text-center"><img src="<?=BASE_URL_SITO?>img/analytics.png" style="width:32px;height:32px"/>  Fonte di prenotazione <b>Newsletter Ads</b>: per campagne social. <small>(tracciabilità ottenuta da UTM QUOTO)</small></h4>                           
                <div class="row">
