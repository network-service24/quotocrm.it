    ...
    <section class="content">
        ...
        <div id="fatturatoN" class="box radius6">
            <div class="box-header with-border">
                ...
                <h3 class="box-title" style="width:100%!important">Totale <b>Fatturato Facebook Ads</b> <i class="fa fa-facebook-square fa-2x"
                                                                                                           style="color:#3B5897"></i> <?= ($totaleFBn > 0 ? ' <span>&#10230;</span> <span class="text-success" style="font-size: 30px;"><i class="fa fa-euro"></i> ' . number_format($totaleFBn, 2, ',', '.') . '</span>' : '') ?>
                </h3>
