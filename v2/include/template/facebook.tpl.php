...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box radius6">
          ...
          <?//if((($_REQUEST['action'] == 'check_year') && ($_REQUEST['querydate'] < ANNO_ADS)) || (($_REQUEST['action'] == 'request_date') && (($DataRichiesta_dal < DATA_ADS) && $DataRichiesta_al < DATA_ADS))){?>                
            <div id="fatturato" class="box radius6">
                  <div class="box-header with-border">
                    <h3 class="box-title" style="width:100%!important">Totale <b>Fatturato Facebook Ads</b> <i class="fa fa-facebook-square fa-2x" style="color:#3B5897"></i> <?=($totaleSocial>0?' <span>&#10230;</span> <span class="text-success" style="font-size: 30px;"><i class="fa fa-euro"></i> '.number_format($totaleSocial,2,',','.').'</span>':'')?></h3>
                    <small><i class="fa fa-exclamation-circle text-info"></i> <b>InfoDesk:</b> questa area riporta dati, campagne e statistiche su preventivi chiusi, utilizzando il solito metodo calcolo statistico in uso dalla pubblicazione di QUOTO! </small>
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <?if(($totaleSocial)>0){?>
                                  ...
                                  <div class="box no-radius">
                                    <div class="box-header with-border">
                                    <h3 class="box-title">Fonte di prenotazione <b>Facebook</b>: suddivisione per campagne social.</h3>
                                      <div class="box-tools pull-right">
