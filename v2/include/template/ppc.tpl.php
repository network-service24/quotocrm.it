          ...
          <?//if((($_REQUEST['action'] == 'check_year') && ($_REQUEST['querydate'] < ANNO_ADS)) || (($_REQUEST['action'] == 'request_date') && (($DataRichiesta_dal < DATA_ADS) && $DataRichiesta_al < DATA_ADS))){?>
            <div id="fatturato" class="box radius6">
                  <div class="box-header with-border">
                      <h3 class="box-title" style="width:100%!important">Totale <b>Fatturato Google Ads</b> <img src="<?=BASE_URL_SITO?>img/gads.png" style="width:32px;height:32px"/><?=($totalePPC>0?' <span>&#10230;</span> <span class="text-success"><i class="fa fa-euro"></i> '.number_format($totalePPC,2,',','.').'</span>':'')?></h3>
                     ...
                     <br>
                      <small><i class="fa fa-exclamation-circle text-info"></i> <b>InfoDesk:</b> questa area riporta dati, campagne e statistiche su preventivi chiusi, utilizzando il solito metodo calcolo statisitco in uso dalla pubblicazione di QUOTO!</small>
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <?if(($totalePPC)>0){?>
                                  ...
                                  <div class="box no-radius">
                                    <div class="box-header with-border">
                                      <h3 class="box-title">Fonte di prenotazione <b>PPC di Google</b>: per campagne.</h3>
                                      <div class="box-tools pull-right">
