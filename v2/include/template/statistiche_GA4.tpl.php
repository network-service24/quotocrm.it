    ...
    <?php include(BASE_PATH_SITO.'include/template/moduli/breadcrumb.inc.php') ?>
        <section class="content">  
                ...
                <div class="alert alert-profila  alert-default-profila alert-dismissable text-center text-black">
                    ...
                    <p>La <b>sincronizzazione</b> dei dati con <b>Analytics GA4</b> ha <b>48 ore di scarto</b>, per esempio: se un preventivo e/o una prenotazione proveniente da "Sito Web -> campagna marketing" entrata il 01-00-0000 sarà visibile nel modulo statistico di GA4 il 03-00-0000</p>                                                                 
                ...
                <div class="col-md-12">               
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            $.ajax({								 
                                type: "POST",								 
                                url: "<?=BASE_URL_SITO?>ajax/statistiche_ga4.php",								 
