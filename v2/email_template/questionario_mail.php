                                                                                                                        ...
                                                                                                                        <tbody>
                                                                                                                           <tr style="vertical-align: central">
                                                                                                                              <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: central;padding-top: 15px;padding-right: 5px;padding-bottom: 10px;padding-left: 10px">
                                                                                                                                 <a href="'.$link.'" style="text-decoration:none"><p style="margin: 0;font-size: 22px;line-height: 25px; color:#FFFFFF"><strong>'.PAGINARISERVATA.' »</strong></p></a>
                                                                                                                                 <a href="'.$link.'" style="text-decoration:none"><p style="margin: 0;font-size: 18px;line-height: 20px; color:#FFFFFF">'.TXTLINK4.'</p></a>
                                                                                                                              </td>
                                                                                                                              <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: central;padding-top: 0px;padding-right: 10px;padding-bottom: 10px;padding-left: 3px; width:95px;" width="95"><a href="'.$link.'" style="text-decoration:none"><img src="'.BASE_URL_SITO.'img/icon_email/stars.png" style="vertical-align:central" alt=">" width="100%" max-width="100%"/></a></td>
                                                                                                                           </tr>
                                                                                                                        </tbody>
                                                                                                                     </table>
                                                                                                                  </div>
