                                                                                          ...
                                                                                          <tbody>
                                                                                            <tr style="vertical-align: central; background-color:'.$BackgroundCellData.'">
                                                                                              <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: central;padding-top: 10px;padding-right: 0px;padding-bottom: 10px;padding-left: 10px; max-width:55px" width="55">
                                                                                                <img src="'.BASE_URL_SITO.'img/icon_email/calendar.png" alt=">" width="50px" max-width="50px" />
                                                                                              </td>
                                                                                                      ...
                                                                                                      <table cellpadding="0" cellspacing="0" width="100%" style="border-spacing: 0;border-collapse: collapse;vertical-align: top">
                                                                                                        <tbody>
                                                                                                          <tr style="vertical-align: central">
                                                                                                            ...
                                                                                                            <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: central;padding-top: 10px;padding-right: 5px;padding-bottom: 10px;padding-left: 5px"><a href="'.$link.'" style="text-decoration:none"><img src="'.BASE_URL_SITO.'img/icon_email/arrow.png" style="vertical-align:central" alt=">" /></a></td>
                                                                                                          </tr>
                                                                                                        </tbody>
                                                                                                      </table>
                                                                                                    </div>
