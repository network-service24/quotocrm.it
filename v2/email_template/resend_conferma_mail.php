...
$res_stile          = mysqli_query($conn,$query_stile);
$rec_stile          = mysqli_fetch_assoc($res_stile);
  ...
  $BackgroundCellLink = '#EF4047';
        ...
        $messaggio .= '<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                                                                                                                               ...
                                                                                                                               <tbody>
                                                                                                                                  <tr style="vertical-align: top">
                                                                                                                                     <td align="left" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;width: 90%;padding-top: 0px;padding-right: 30px;padding-bottom: 0px;padding-left: 5px">
                                                                                                                                        <div align="left" style="width:215px" width="215"><b>'.($logo!=''?'<img src="'.$BaseUrlSuiteweb.'v2/uploads/loghi_siti/'.$logo.'" alt="'.$rows['nome'].'" class="center fullwidth" align="left" border="0" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block;border: 0;height: auto;line-height: 100%;margin: 0 auto;float: none;width: 215px;max-width: 215px" width="215" data-bee="true">':ucfirst($rows['nome'])).'</b></div>
                                                                                                                                     </td>
                                                                                                                                  </tr>
                                                                                                                               </tbody>
                                                                                                                            </table>
                                                                                                                           ...
                                                                                                                           <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;padding-top: 10px;padding-right: 10px;padding-bottom: 5px;padding-left: 10px">
                                                                                                                              <div style="color:#5E5E5E;line-height:120%;font-family:Georgia, serif;">
                                                                                                                                 <div style="font-size:16px;line-height:14px;color:#5E5E5E;font-family:Georgia, serif;text-align:left;">
                                                                                                                                    <p style="margin: 0;font-size: 16px;line-height: 17px"><b>'.$_pagamento.'</b></p>
                                                                                                                                 </div>
                                                                                                                              </div>
                                                                                                                           </td>
                                                                                                                        </tr>
                                                                                                                              ...
                                                                                                                              <div style="color:#FFFFFF;line-height:120%;font-family:Georgia, serif;">
                                                                                                                                 <div style="font-size:12px;line-height:14px;color:#5E5E5E;font-family:Georgia, serif;text-align:left;">
                                                                                                                                    <table cellpadding="0" cellspacing="0" width="100%" style="border-spacing: 0;border-collapse: collapse;vertical-align: top">
                                                                                                                                       <tbody>
                                                                                                                                          <tr style="vertical-align: central">
                                                                                                                                             <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: central;padding-top: 15px;padding-right: 15px;padding-bottom: 15px;padding-left: 15px"><img src="'.$BaseUrlSito.'img/icon_email/check.png" style="vertical-align:central" alt=">" width="70px" max-width="70px"/></td>
                                                                                                                                             <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: central;padding-top: 15px;padding-right: 15px;padding-bottom: 15px;padding-left: 15px">
                                                                                                                                                <p style="margin: 0;font-size: 18px;line-height: 25px; color:#5E5E5E; font-style:italic">';
                                                                                                                                if($AccontoRichiesta != 0 && $AccontoLibero == 0) {
                                                                                                                                  $messaggio .=''.$_acconto.': ('.$AccontoRichiesta.' %)   <b>€. '.number_format(($PrezzoPC*$AccontoRichiesta/100),2,',','.').'</b></p>';
                                                                                                                                }
                                                                                                                                if($AccontoRichiesta == 0 && $AccontoLibero != 0) {
                                                                                                                                  $messaggio .=''.$_acconto.': <b>€. '.number_format($AccontoLibero,2,',','.').'</b></p>';
                                                                                                                                }
                                                                                                                                if($AccontoPercentuale != 0 && $AccontoImporto == 0) {
                                                                                                                                  $messaggio .=''.$_acconto.': ('.$AccontoPercentuale.' %)   <b>€. '.number_format(($PrezzoPC*$AccontoPercentuale/100),2,',','.').'</b></p>';
                                                                                                                                }
                                                                                                                                if($AccontoPercentuale == 0 && $AccontoImporto != 0) {
                                                                                                                                  if($AccontoImporto >= 1){
                                                                                                                                    $messaggio .=''.$_acconto.': <b>€. '.number_format($AccontoImporto,2,',','.').'</b></p>';
                                                                                                                                  }else{
                                                                                                                                      $messaggio .= '<b>'.CARTACREDITOGARANZIA.'</b></p>';
                                                                                                                                  }
                                                                                                                                }
                                                                                                                                  $messaggio .='</td>
                                                                                                                                          </tr>
                ...
                $messaggio .='      <table cellpadding="0" cellspacing="0" align="center" width="100%" border="0" style="border-spacing: 0;border-collapse: collapse;vertical-align: top">
                                                                                                                        ...
                                                                                                                        <tbody>
                                                                                                                           <tr style="vertical-align: central">
                                                                                                                              <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: central;padding-top: 15px;padding-right: 5px;padding-bottom: 10px;padding-left: 10px">
                                                                                                                                 <a href="'.$link.'" style="text-decoration:none"><p style="margin: 0;font-size: 22px;line-height: 25px; color:#FFFFFF"><strong>'.$_acconto_offerta.' »</strong></p></a>
                                                                                                                                 <a href="'.$link.'" style="text-decoration:none"><p style="margin: 0;font-size: 18px;line-height: 20px; color:#FFFFFF">'.$_txtlink3.'</p></a>
                                                                                                                              </td>
                                                                                                                              <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: central;padding-top: 10px;padding-right: 10px;padding-bottom: 10px;padding-left: 5px; width:60px" width="60"><a href="'.$link.'" style="text-decoration:none"><img src="'.$BaseUrlSito.'img/icon_email/card.png" style="vertical-align:central" alt=">" width="100%" max-width="100%"/></a></td>
                                                                                                                           </tr>
                                                                                                                        </tbody>
                                                                                                                     </table>
                                                                                                                  </div>
                  ...
                  $qry = mysqli_query($conn,"SELECT * FROM hospitality_minigallery WHERE idsito = ".$IdSito." ORDER BY Id DESC LIMIT 3");
                  $res_img = mysqli_num_rows($qry);
                  if(($res_img)>0){
                      $messaggio .='
                                    <table cellpadding="0" cellspacing="0" align="center" width="100%" border="0" style="border-spacing: 0;border-collapse: collapse;vertical-align: top">
                                      <tbody>
                                                                                          ...
                                                                                          <tbody>
                                                                                            <tr style="vertical-align: top">
                                                                                              <td align="center" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;width: 100%;padding-top: 0px;padding-right: 0px;padding-bottom: 0px;padding-left: 0px">
                                                                                                <div align="center" style="font-size:12px"> <img class="center fullwidth" align="center" border="0" src="'.$BaseUrlSito.'uploads/'.$IdSito.'/'.$value['Immagine'].'" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block;border: 0;height: auto;line-height: 100%;margin: 0 auto;float: none;width: 100% !important;max-width: 216px" width="216" data-bee="true"> </div>
                                                                                              </td>
                                                                                            </tr>
                                                                                          </tbody>
                                                                                        </table>
