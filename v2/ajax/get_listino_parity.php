...
mysqli_set_charset($conn,'utf8');
    ...
    if($TipoListino==0){
        ...
        $testo = '<small>Somma Prezzo camera €: <b>'.number_format($PrezzoCamera,2,',','.').'</b> <span class="text-red">X</span> n° camere: <b>'.$numero_camera.'</b> <span class="text-red">X</span> n* di notti: <b>'.$notti.'</b></small></div>';
    }else{
