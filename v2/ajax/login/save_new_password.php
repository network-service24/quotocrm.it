...
include($_SERVER['DOCUMENT_ROOT']."/v2/include/function.inc.php");
 	...
 	if($_POST['check_password']!=''){					
            ...
            $insert = "INSERT INTO utenti_password(idutente,idsito,password) VALUES('".$_POST['idutente']."','".$_POST['idsito']."','".addslashes($_POST['check_password'])."')";
            $dbMysqli_suiteweb->query($insert);
            #update password account di suiteweb tabella utenti
            $update = "UPDATE utenti_quoto SET password = '".addslashes($_POST['check_password'])."', data_account = '".date('Y-m-d')."' WHERE id = '".$_POST['idutente']."' ";
