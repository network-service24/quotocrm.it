...
$idsito = $_REQUEST['idsito'];
  ...
  function leadtime_prenotazioni(){
    global $db,$idsito,$p_data,$s_data;
    ...
    if($s_data == ''){
      ...
      if(($tot)>0){
          ...
          if(!empty($output) && !is_null($output)){
              ...
              $valore .= '<div class="col-md-8 text-justify h4">Il Tempo medio dall\'arrivo o inserimento di una richiesta (<b>preventivo</b>) alla sua trasformazione in <b>Conferme</b> e/o <b>Prenotazione</b> è pari a:</div>';
              $valore .= '<div class="col-md-2 text-center h4"><span>&#10230;</span></div>';

              $valore .= '<div class="col-md-2">';
