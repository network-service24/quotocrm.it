...
function numero_campagne($idsito, $tracking, $campagna)
{
    ...
    $select = " 	SELECT  (hospitality_guest.Id) AS n
                    ...
                    AND hospitality_custom_dimension_ga4.campaign = '" . addslashes($campagna) . "'
...
if ($totCampn > 0) {
    ...
    foreach ($rws9n as $key9n => $value9n) {
        ...
        $numero_campagne    = numero_campagne($idsito, 'google', $value9n['Campagna']);
        $numero_prev_send  = numero_preventivi_inviati_per_campagna($idsito, 'google', $value9n['Campagna']);
