...
$row     = mysqli_fetch_assoc($sq);
    ...
    if($user !='' && $pass !=''){ 
        ...
        if(strstr($server,'gmail')){
            ...
            $q = "SELECT * FROM hospitality_data_import_nono_portale WHERE idsito = ".$idsito." ORDER BY Id DESC";
                    ...
                    foreach($emails as $mail) {
                        ...
                        $maildata = $data_anno.'-'.$mesi[$data_mese].'-'.$data_giorno.' '.$ora_mail;
                            ...
                            if($maildata > $last_data_import){ 
                                ...
                                if(strstr($headerInfo->subject,'hotel-facile.it')){ 
            ...
            if(!empty($array_contenuti_email)){
              ...
              foreach($array_contenuti_email as $key => $value){
                    ...
                    if($key != ''){
                     ...
                     foreach($value as $k => $val){
                        ...
                        $Camere             = '';
                                            ...
                                            //
                                            $FontePrenotazione  = 'hotel-facile.it';
                ...
                $syncro = "INSERT INTO hospitality_data_import_nono_portale(idsito,data) VALUES('".$idsito."','".date('Y-m-d H:i:s')."')";
            ...
            for($i=$total-1;$i>=0;$i--) {
                ...
                $maildata = $data_m[2].'-'.$mesi[$data_m[1]].'-'.$data_m[0].' '.$ora_mail;
                    ...
                    if($maildata > $last_data_import){  
                        ...
                        if((strstr($email['header']->subject,'Richiesta')) && (strstr($email['header']->subject,'hotel-facile.it'))){
