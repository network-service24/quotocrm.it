    ...
    if($notti!='' && $notti !='undefined'){
        ...
        if($ret['CalcoloPrezzo']=='Al giorno'){
            ...
            if($PrezzoServizio!='' && $PrezzoServizio!='0'){
                ...
                $testo = '<div><small><small>Prezzo non impostato oppure gratuito!</small></small></div>';
            }
            ...
            //}else{
                //$testo = '<div><small>Il prezzo del servizio non è stato impostato oppure è gratuito!</small></div>';
            //}
