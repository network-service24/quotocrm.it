...
$totalePPCn = $fun->fatt_utm($idsito,$filter_query,'facebook','social');

$rws9n      = $fun->campagne_utm($idsito,'facebook','social');
...
if ($totCampn > 0) {
    ...
    foreach ($rws9n as $key9n => $value9n) {
        ...
        $numero_campagne   = $fun->CountRicevuteCampagnaAds($idsito,$value9n['Campagna'],'facebook','social',$filter_query);
        $numero_prev_send  = $fun->CountInviateCampagnaAds($idsito,$value9n['Campagna'],'facebook','social',$filter_query);
        $preno_chiuse      = $fun->CountConfermateCampagnaAds($idsito,$value9n['Campagna'],'facebook','social',$filter_query);
        $totalePerCampagna = $fun->fatturato_per_campagna($idsito, $value9n['Campagna'],'facebook','social',$filter_query);
