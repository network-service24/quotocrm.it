                    ...
                    foreach($emails as $key => $mail) {
                        ...
                        $maildata = $data_anno.'-'.$mesi[$data_mese].'-'.$data_giorno.' '.$ora_mail;
                            ...
                            if($maildata > $last_data_import){ 
                                ...
                                if(strstr($headerInfo->subject,'Richiesta di informazioni')){ 
                    ...
                    if($key != ''){
                     ...
                     foreach($value as $k => $val){
                        ...
                        $Camere             = '';
                                            ...
                                            $cliente__          =   explode(":",$risultato[2]);
                                            $cliente_           =   explode(" ",trim($cliente__[1]));
                                            ...
                                            $Email =  $risultato[0]; 
                                            $DataArrivo__          =  explode(":",$risultato[3]); 
                                            $DataArrivo_           =  explode("/",$DataArrivo__[1] );            
                                            $DataArrivo            =  trim($DataArrivo_[2]).'-'.trim($DataArrivo_[1]).'-'.trim($DataArrivo_[0]);
                                            $DataPartenza__        =  explode(":",$risultato[4]); 
                                            $DataPartenza_         =  explode("/",$DataPartenza__[1]);            
                                            $DataPartenza          =  trim($DataPartenza_[2]).'-'.trim($DataPartenza_[1]).'-'.trim($DataPartenza_[0]);
                                         
                                            $adulti_               =  explode(":",$risultato[5]); 
                                            if(strstr($adulti_[1],'1 adulto')){
                                                $NumeroAdulti        =   1;
                                            }elseif(strstr($adulti_[1],'2 adulti')){
                                                $NumeroAdulti        =   2;
                                            }elseif(strstr($adulti_[1],'3 adulti')){
                                                $NumeroAdulti        =   3;
                                            }elseif(strstr($adulti_[1],'4 adulti')){
                                                $NumeroAdulti        =   4;
                                            }
                                            $bambini_                =  explode(":",$risultato[6]); 
                                            if(strstr($bambini_[1],'1 bambino')){
                                                $NumeroBambini        =   1;
                                            }elseif(strstr($bambini_[1],'2 bambini')){
                                                $NumeroBambini        =   2;
                                            }elseif(strstr($bambini_[1],'3 bambini')){
                                                $NumeroBambini        =   3;
                                            }elseif(strstr($bambini_[1],'4 bambini')){
                                                $NumeroBambini        =   4;
                                            }
                                            $cell_                =  explode(":",$risultato[8]); 
                                            $Cellulare =  trim($cell_[1]);
                                            $bambini_                =  explode(":",$risultato[7]); 
                                            $EtaBambini = $bambini_[1];
                                            $Lingua                 =   'it';   
                                            $Note                   = ($NumeroBambini > 0?'Età: '.$EtaBambini."\r\n":'').'Note: '.$risultato[7].$risultato[13];
                                            $AbilitaInvio           = '0';
                    ...
                    foreach($emails as $key => $mail) {
                        ...
                        $maildata = $data_anno.'-'.$mesi[$data_mese].'-'.$data_giorno.' '.$ora_mail;
                            ...
                            if($maildata > $last_data_import){ 
                                ...
                                if(strstr($headerInfo->from,'Richiesta di informazioni')){ 
