...
if($action == 're_calc'){
    ...
    $re_testo .='<div><small>(<b>'.$prezzo.'</b> <span class="text-red">X</span> <b>'.$notti.'</b> <span class="text-red">X</span> <b>'.$NPersone.'</b> <span class="text-red">=</span> <b>'.$totale_unitaro_servizio.'</b>)</small></div>';
