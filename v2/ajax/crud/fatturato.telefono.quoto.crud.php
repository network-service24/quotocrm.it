...
foreach ($lista_tel as $key => $value) {
            ...
            $fatturato = number_format($cdPrice, 2, ',', '.');
...
/*          $fatturato = '  <div id="fatturato_loading'.$row['Id'].'"></div>
        ...
        $fatturato .= ' <script>
                            $(document).ready(function () {
                                ...
                                $("#fatturato'.$row['Id'].'").load("'.BASE_URL_SITO.'ajax/crud/calc.fatturato.tel.qt.crud.php?idsito='.$idsito.'&id='.$row['Id'].'", function() {
    ...
    if($tot > 0){
                        ...
                        $data[] = array(													
                                        ...
                                        "fatturato"             => '<div class="text-right small nowrap">'.$fatturato.'</div>'
                                        );
